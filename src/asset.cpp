    ...
    wtxNew.BindWallet(pwalletMain);
    {
        ...
        loop {
            ...
            if (nTotalValue > 0) {
            	...
            	bool bRet;
            	if(!isControlOp)
            		bRet = pwalletMain->SelectAssetCoins(asset.vchSymbol, nValue, setCoins, nValueIn);
            	else
            		bRet = pwalletMain->SelectAssetControlCoins(asset.vchSymbol, nValue, setCoins, nValueIn);
